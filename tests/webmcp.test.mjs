...
test("guided view is a bounded read-only action and delegates consent to the human surface", async () => {
  ...
  assert.deepEqual(guide.inputSchema.properties.target.enum, ["top", "plan_ideas", "planning_window", "build_method", "manual_details", "starting_point", "status", "question", "priority", "review", "interpretation", "updates", "plan_summary", "budget_editor", "stages", "options", "approval", "receipt"]);
