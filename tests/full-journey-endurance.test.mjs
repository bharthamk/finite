...
const applyPreference = async (host, runtime, changes, id) => {
  ...
  const feedback = requireCode(await host.execute("finite_record_consumer_feedback", { message: `Human preference reversal in ${id}: choose lived experience over the numerically cheapest route.`, kind: "taste" }), "FEEDBACK_RECORDED");
