...
5. At the visible decision boundary, choose any **Use this option** button,
   review the exact effect, and select **Confirm and update plan**. Codex cannot
   perform either human action.
