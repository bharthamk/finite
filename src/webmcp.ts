...
const routeRefreshToolNames = new Set([
  "finite_invoke",
  "finite_open_kitchen", "finite_enter_kitchen", "finite_get_chef_menu", "finite_create_arrival_order", "finite_append_arrival_input", "finite_save_workspace_option", "finite_save_workspace_module", "finite_reconcile_arrival", "finite_checkpoint_arrival", "finite_stage_clarification", "finite_stage_interpretation",
