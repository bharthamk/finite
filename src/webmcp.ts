...
export const finiteGuideTargets = ["top", "plan_ideas", "planning_window", "build_method", "manual_details", "starting_point", "status", "question", "priority", "review", "interpretation", "updates", "plan_summary", "section_headers", "budget_editor", "stages", "options", "approval", "receipt"] as const;
