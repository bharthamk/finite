...
const travelScheduleFields = [field("title", "Location or activity", "text", "City, region, visit, event, or activity"), field("kind", "Type", "select", "", calendarKindOptions), field("location", "Location", "text", "City or area"), field("start", "Start date", "date"), field("startTime", "Start time", "time"), field("end", "End date", "date"), field("endTime", "End time", "time"), field("dailyBudget", "Daily spend", "number", "0"), field("currency", "Currency", "text", "AUD"), field("reference", "Website or reference", "url", "https://"), field("notes", "Notes", "textarea", "What is fixed, flexible, or still unknown?")];
...
const starterSections: Record<StarterPlanPresentation["family"], StarterSectionDefinition[]> = {
  travel: [
    ...
    { sectionId: "stays", label: "Where you’re staying", description: "Compare compact stay options, their dates, booking state, website and full allowance.", emptyLabel: "No accommodation added yet.", variant: "stays", fields: [field("title", "Stay", "text", "Hotel, hostel, apartment, friend…"), field("location", "Location", "text", "City, area, or neighbourhood"), field("bookingStatus", "Booking state", "select", "", bookingStatusOptions), field("start", "Check-in", "date"), field("end", "Check-out", "date"), field("website", "Website", "url", "https://"), field("nightlyBudget", "Nightly budget", "number", "0"), field("totalBudget", "Full-stay budget", "number", "0"), field("currency", "Currency", "text", "AUD"), field("notes", "Notes", "textarea")], keywords: ["accommodation", "hotel", "hostel", "lodging", "stay", "nightly", "checkin", "checkout"] },
    { sectionId: "transport", label: "Flights & transport", description: "Keep options and confirmed legs together without pretending an option is booked.", emptyLabel: "No flights or transport added yet.", variant: "transport", fields: [field("title", "Flight or transport", "text", "Flight, train, bus, ferry…"), field("bookingStatus", "Booking state", "select", "", bookingStatusOptions), field("from", "From", "text"), field("to", "To", "text"), field("start", "Departure date", "date"), field("startTime", "Departure time", "time"), field("end", "Arrival date", "date"), field("endTime", "Arrival time", "time"), field("provider", "Provider / service", "text", "Airline, train, flight number…"), field("cost", "Planned cost", "number", "0"), field("currency", "Currency", "text", "AUD"), field("reference", "Booking or option link", "url", "https://"), field("notes", "Notes", "textarea")], keywords: ["flight", "airline", "airport", "booking", "transport", "train", "ferry", "bus", "car", "connection"] },
