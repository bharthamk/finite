...
export interface StarterPlanField {
  fieldId: string;
  label: string;
  inputType: "text" | "date" | "time" | "number" | "textarea" | "select";
  placeholder?: string;
...
const scheduleFields = [field("title", "Item", "text", "Name this event, activity, phase, or milestone"), field("location", "Location", "text", "Place, room, owner, or context"), field("start", "Start date", "date"), field("startTime", "Start time", "time"), field("end", "End date", "date"), field("endTime", "End time", "time"), field("notes", "Notes", "textarea", "What is fixed, flexible, or still unknown?")];
const travelScheduleFields = [field("title", "Location or activity", "text", "City, region, visit, event, or activity"), field("location", "Location", "text", "City or area"), field("start", "Start date", "date"), field("startTime", "Start time", "time"), field("end", "End date", "date"), field("endTime", "End time", "time"), field("dailyBudget", "Daily spend", "number", "0"), field("currency", "Currency", "text", "AUD"), field("notes", "Notes", "textarea", "What is fixed, flexible, or still unknown?")];
