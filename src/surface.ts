...
const coreActions = [
  "finite_get_capabilities", "finite_list_plans", "finite_get_plan_blueprint", "finite_assess_plan_intake", "finite_get_plan_state", "finite_get_movable_set", "finite_record_change_event",
